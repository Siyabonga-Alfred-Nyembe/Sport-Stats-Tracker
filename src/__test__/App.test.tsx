...
vi.mock("../pages/forgot", () => ({ default: () => <div>Forgot Password Page</div> }));
vi.mock("../pages/reset", () => ({ default: () => <div>Reset Password Page</div> }));
vi.mock("../pages/land", () => ({ default: () => <div>Land Page</div> }));
