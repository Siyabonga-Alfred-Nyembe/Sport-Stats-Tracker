...
export async function upsertPlayerStats(
  ...
  try {
    ...
    const validStatsData = {
      ...
      dribbles_successful: statsData.dribbles_successful,
      ...
      clean_sheets: statsData.clean_sheets,
      save_percentage: statsData.save_percentage,
      pass_completion: statsData.pass_completion,
      minutes_played: statsData.minutes_played,
      yellow_cards: statsData.yellow_cards,
      red_cards: statsData.red_cards,
      match_id: matchId,
      player_id: playerId
    };
